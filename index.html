...
<body>
    <header class="l-header">
        <div class="header-company">
            <div>
                <h1 class="header-company__name"><a href="/">I.M.Aクリーン産業株式会社</a></h1>
            </div>
        </div>
        <div class="flex">
            <div class="gnav">
    ...
    <main>
        ...
        <section class="l-section">
            <div class="wrapper">
                ...
                <div class="l-seciton__link">
                    <a href="aboutus.html" class="link-btn"><i class="fas fa-arrow-circle-right"></i> 企業情報</a>
                </div>
            </div>
        </section>
        ...
        <section class="l-section">
            <div class="wrapper">
                ...
                <div class="l-seciton__link">
                    <a href="service.html" class="link-btn"><i class="fas fa-arrow-circle-right"></i> サービス一覧</a>
                </div>
            </div>
        </section>
        ...
        <section class="l-section">
            <div class="wrapper">
                ...
                <div class="l-seciton__link">
                    <a href="news.html" class="link-btn"><i class="fas fa-arrow-circle-right"></i> お知らせ一覧</a>
                </div>
            </div>
        </section>
